        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cooks_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cooks_Countries_CountryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cooks_CategoryId",
                table: "Cooks",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Cooks_CountryId",
                table: "Cooks",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_CookId",
                table: "Images",
                column: "CookId");
        }
